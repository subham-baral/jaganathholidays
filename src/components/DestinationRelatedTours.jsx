...
const defaultTours = [
  {
    ...
    description: "Odisha is known as the Golden Triangle and is celebrated among travelers with picturesque cities of Puri & Bhubaneswar.",
  ...
  },
  {
    ...
    description: "An authentic cultural and heritage tour exploring traditional art, crafts, and heritage of local tribal villages.",
    ...
    <div className={styles.tourCard}>
      ...
      <div className={styles.cardContent}>
        ...
        <div className={styles.cardFooter}>
          ...
          <Link href={`/package/${tour.slug}`} className={styles.bookLink}>
...
export default function DestinationRelatedTours({ relatedTours = [] }) {
  const tours = Array.isArray(relatedTours) && relatedTours.length > 0
    ? relatedTours.map((t, idx) => ({
        ...
        description: (typeof t.data?.description === 'string' ? t.data.description.replace(/<[^>]+>/g, '').slice(0, 100) + '...' : t.description) || 'Explore amazing destinations with curated sightseeing.',
